...
//        return new ResponseEntity<>(new ApiResponse<>("Weight Limit exceeded", false), FORBIDDEN);
//    }
    public static ResponseEntity<ApiResponse> overWeight (Object response) {
...
//        return new ResponseEntity<>(new ApiResponse<>("Drone battery too low", false), FORBIDDEN);
//    }
